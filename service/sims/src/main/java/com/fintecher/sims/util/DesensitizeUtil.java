 ...
 * @Date:Created on 2018/1/10 11:47
 * @Modified By：
 */
public class DesensitizeUtil {
    ...
    public static String idCardNum(String id) {
        ...
        return StringUtils.left(id, 3).concat(StringUtils.removeStart(StringUtils.leftPad(StringUtils.right(id, 4), id.length(), "*"), "***"));
    }
    ...
    public static String bankCard(String cardNum) {
        ...
        return StringUtils.left(cardNum, 4).concat(StringUtils.removeStart(StringUtils.leftPad(StringUtils.right(cardNum, 4), cardNum.length(), "*"), "******"));
    }
