...
<div class="wrap"> 
  ...
  <p>乙方（借款人）：<span class="xhline shangfang">${custName}</span>身份证号码：<span class="xhline shangfang">${custIc}</span></p>
  
  <div class="h4t">第一条 借款信息</div>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="110">借款本金（人民币）</td>
      <td colspan="2">${contracyMoney}元</td>
      <td colspan="2">${contracyMoneyRMB}</td>
    </tr>
    <tr>
      <td>借款年利率</td>
      <td width="50">${invest_rate}%</td>
      <td width="80">借款用途</td>
      <td colspan="2">${repayment_purpose}</td>
    </tr>
   
    <tr>
      <td rowspan="2">借款人收款账户</td>
      <td>开户行</td>
      <td colspan="3">${borrowerBank}</td>
    </tr>
    <tr>
      <td>户名</td>
      <td>${borrowerAccount}</td>
      <td width="30">帐号</td>
      <td>${borrowerCard}</td>
    </tr>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="110">还款分期周数</td>
      <td width="50">${periods}<span>月</span></td>
      <td>每周月偿还本息数额</td>
    ...
    <tr>
      ...
      <td>开户行</td>
      <td colspan="3">${investors.borrowerBank}</td>
    </tr>
    <tr>
     <td>户名</td>
  ...
  <p style="text-indent:2em">借款人至少提前三个工作日以书面方式提出，借款人应向出借人支付当月应还款和剩余全部本金，</p>
  ...
  <p class="lm30">的方式发送至乙方下列邮箱<span class="xhline">${map.email}</span>或将《债权转让通知》以站内信方式发送至乙方在</p>
 ...
 <#if (icAddress) == "null">
  ...
  <p class="lm30">协议项下任一条款如有与 中国法律中的强制性规范相抵触，应在该等强制性规范所不受禁止的最大</p>
  ...
  <p>（4）甲方同意，如果乙方逾期还款达到30天，则甲方的债权自动无偿转让给苏州东方信泰金融信息服务有限公司管理有限公</p>
  <p class="lm30">司，苏州东方信泰金融信息服务有限公司有权以自己的名义直接向乙方主张债权，乙方对此条款理解无误。</p>
